...
export const PROJECTS = [
    {
        ...
        description: 'Proyecto de terrenos urbanizados con vista al mar en El Tabo. Lotes desde 200 m² con rol propio, agua certificada, luz y portón automático.',
        ...
        lotSize: 'Desde 200 m²',
        status: 'En venta',
        externalUrl: 'https://aliminlomasdelmar.com',
    ...
    },
    {
        ...
        description: 'Terrenos urbanizados de 200 m² en la comuna de El Tabo. Más del 50% vendido. A 10 minutos de la playa en auto.',
        features: ['Rol Propio', 'Agua Certificada', 'Luz Eléctrica', 'Portón Automático'],
        location: 'El Tabo, Región de Valparaíso',
    ...
    },
    {
        ...
        description: 'Nuevo proyecto de terrenos en El Tabo, Litoral Central. Invierte en tu futuro con terrenos urbanizados en una ubicación privilegiada.',

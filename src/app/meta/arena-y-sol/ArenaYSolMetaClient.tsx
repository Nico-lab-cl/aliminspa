...
/* UTM con las que se abre el chat si el anuncio no trae las suyas. Son las
   mismas del formulario, así una conversación que nace de un anuncio llega al
   CRM marcada como pagada y no se confunde con el tráfico de la página real. */
const UTM_CHAT = {
    utm_source: 'meta',
...
// El copy dejó de mostrar cuántos lotes quedan (agosto 2026): la urgencia se
// comunica con "últimos terrenos disponibles", que no hay que venir a corregir
// cada vez que se vende uno ni queda desmentido si el visitante vuelve a la
// semana. El porcentaje vendido queda explícito porque ya no se puede derivar
// de un conteo que dejamos de mantener: es el único número que sigue a la
// vista, en la barra de progreso.
const VENDIDOS_PCT = 60
                            ...
                            >
                                ...
                                <div style={{ position: 'absolute', bottom: '20px', left: '20px', right: '20px' }}>
                                    ...
                                    <div style={{ font: "800 20px 'Montserrat',sans-serif", letterSpacing: '-.02em', color: '#fff' }}>
                                        Últimos terrenos de 200 m² disponibles
                                    </div>
                                </div>
                            </div>
                        </div>

...
const project = PROJECTS[2] // Libertad y Alegría

export const metadata: Metadata = {
    title: `${project.name} | Nuevo Proyecto de Terrenos en El Tabo`,
    description: project.description,
    alternates: { canonical: `${SITE.url}/proyectos/${project.slug}` },
}

export default function LibertadYAlegria() {
    return (
        <>
            <BreadcrumbSchema
                items={[
                    ...
                    <div className="container">
                        ...
                        <AnimatedSection delay={200}>
                            <div style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', marginBottom: '3rem', border: '1px solid var(--border)' }}>
                                <Image
                                    src={project.image}
                                    alt={`${project.name} - Nuevo proyecto de terrenos en El Tabo, Litoral Central`}
                                    width={1200}
                                    height={600}
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '3rem' }}>
                            ...
                            <AnimatedSection delay={150}>
                                <div style={{
                                    ...
                                    <Link
                                        href={`https://wa.me/56956654833?text=Hola,%20quiero%20información%20sobre%20${project.name}%20🏡`}

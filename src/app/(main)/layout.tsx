...
export default function MainLayout({
    ...
    return (
        <>
            ...
            <a
                href="/reunion"
                className="booking-float crm-track-click"
                aria-label="Agenda tu Visita"
                id="booking-float"
                data-crm-name="Agendar Visita - Boton Flotante"
            ...
            <a
                ...
                className="whatsapp-float crm-track-click"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Contactar por WhatsApp"
                id="whatsapp-float"
                data-crm-name="WhatsApp - Boton Flotante"

...
export default function TeamPage() {
    return (
        <main className={styles.page}>
            ...
            {/* Background is removed from here to prevent Navbar bleeding */}

            {/* Mision y Vision Section */}
            <section className={styles.mvSection}>
                <div className={styles.mvBgWrapper}>
                    <iframe
                        className={styles.mvVideo}
                        src="https://www.youtube.com/embed/M0T_g08y5k8?autoplay=1&mute=1&controls=0&loop=1&playlist=M0T_g08y5k8&rel=0&showinfo=0&modestbranding=1&playsinline=1"
                        allow="autoplay; encrypted-media"
                        allowFullScreen
                        title="Sunset Drone Video Background"
                    />
            ...
            <div style={{ position: 'relative', overflow: 'hidden', paddingBottom: '4rem' }}>
                {/* Premium Animated Background restricted to this wrapper */}

                ...
                <div className={styles.grid}>
                    <div className={styles.brand}>
                        ...
                        <div className={styles.socials}>
                            ...
                            <a 
                                href="https://wa.me/56956654833?text=Hola%2C%20me%20comunico%20desde%20aliminspa.cl%20%F0%9F%91%8B" 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                aria-label="WhatsApp"
                                className="crm-track-click"
                    ...
                    <div className={styles.col}>
                        ...
                        <ul className={styles.list}>
                            ...
                            <li><Link href="/terminos-del-servicio">Términos del Servicio</Link></li>
                        </ul>
                    </div>
                        ...
                        <ul className={styles.list}>
                            <li>
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className={`${styles.contactLink} crm-track-click`}
                                    data-crm-name="WhatsApp Contacto - Footer"
                                    data-crm-category="Contacto Directo"
                                >
                            ...
                            <li className={styles.address}>
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="18" height="18"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
                                {SITE.address}
                            </li>
                        </ul>
                    </div>
